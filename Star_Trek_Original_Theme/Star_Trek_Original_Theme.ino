/*
  tone() Melody Player With Melodies Converted From amitrek.mid
  ------------------------------------------------------------------------------  
...
void loop() 
{
  ...
  // from amitrek.mid and are encoded below in 
  // the Melody Data section.
  
  // 0 - Theme from "Star Trek"
  // 1 - by Alexander Courage
  // 2 - --
  // 3 - This file is a MIDI version
...
// Track 0 - Theme from "Star Trek"
static const uint16_t Melody0[] PROGMEM = { 
            NOTE_G_4(  23 ),  NOTE_SILENT(   2 ),     NOTE_F_5(  35 ),  NOTE_SILENT(   2 ), 
            NOTE_E_5(  11 ),  NOTE_SILENT(   2 ),     NOTE_D_5(   7 ),  NOTE_SILENT(   2 ), 
            NOTE_C_5(   7 ),  NOTE_SILENT(   2 ),     NOTE_B_4(   7 ),  NOTE_SILENT(   2 ), 
           NOTE_AS_4(  83 ),  NOTE_SILENT(   2 ),    NOTE_GS_4(  11 ),  NOTE_SILENT(   2 ), 
            NOTE_G_4(  23 ),  NOTE_SILENT(   2 ),     NOTE_G_5(  35 ),  NOTE_SILENT(   2 ), 
            NOTE_F_5(  11 ),  NOTE_SILENT(   2 ),     NOTE_E_5(   7 ),  NOTE_SILENT(   2 ), 
            NOTE_D_5(   7 ),  NOTE_SILENT(   2 ),     NOTE_C_5(   7 ),  NOTE_SILENT(   2 ), 
            NOTE_B_4(  83 ),  NOTE_SILENT(   2 ),    NOTE_AS_4(  11 ),  NOTE_SILENT(   2 ), 
            NOTE_A_4(  35 ),  NOTE_SILENT(   2 ),     NOTE_B_4(  11 ),  NOTE_SILENT(   2 ), 
           NOTE_CS_5(  11 ),  NOTE_SILENT(   2 ),     NOTE_D_5(  11 ),  NOTE_SILENT(   2 ), 
            NOTE_E_5(   5 ),  NOTE_SILENT(   2 ),    NOTE_FS_5(   5 ),  NOTE_SILENT(   2 ), 
            NOTE_G_5(   5 ),  NOTE_SILENT(   2 ),     NOTE_A_5(   5 ),  NOTE_SILENT(   2 ), 
            NOTE_A_5(  17 ),  NOTE_SILENT(   2 ),    NOTE_AS_5(   5 ),  NOTE_SILENT(   2 ), 
           NOTE_AS_5(  65 ),  NOTE_SILENT(   8 ),    NOTE_AS_4(  35 ),  NOTE_SILENT(   2 ), 
            NOTE_C_5(  11 ),  NOTE_SILENT(   2 ),     NOTE_D_5(  11 ),  NOTE_SILENT(   2 ), 
           NOTE_DS_5(  11 ),  NOTE_SILENT(   2 ),     NOTE_F_5(   5 ),  NOTE_SILENT(   2 ), 
            NOTE_G_5(   5 ),  NOTE_SILENT(   2 ),    NOTE_GS_5(   5 ),  NOTE_SILENT(   2 ), 
           NOTE_AS_5(   5 ),  NOTE_SILENT(   2 ),    NOTE_AS_5(  17 ),  NOTE_SILENT(   2 ), 
            NOTE_B_5(   5 ),  NOTE_SILENT(   2 ),     NOTE_B_5(  65 ),  NOTE_SILENT(   8 ), 
            NOTE_G_5(  23 ),  NOTE_SILENT(   2 ),     NOTE_F_6(  35 ),  NOTE_SILENT(   2 ), 
            NOTE_E_6(  11 ),  NOTE_SILENT(   2 ),     NOTE_D_6(   5 ),  NOTE_SILENT(   2 ), 
            NOTE_C_6(   5 ),  NOTE_SILENT(   2 ),     NOTE_B_5(   5 ),  NOTE_SILENT(   2 ), 
           NOTE_AS_5(  89 ),  NOTE_SILENT(   2 ),    NOTE_GS_5(  11 ),  NOTE_SILENT(   2 ), 
            NOTE_G_5(  23 ),  NOTE_SILENT(   2 ),     NOTE_G_6(  35 ),  NOTE_SILENT(   2 ), 
            NOTE_F_6(  11 ),  NOTE_SILENT(   2 ),     NOTE_E_6(   5 ),  NOTE_SILENT(   2 ), 
  };
static const uint16_t Melody0_Length    = sizeof( Melody0 ) / sizeof(uint16_t);

// Track 1 - by Alexander Courage
static const uint16_t Melody1[] PROGMEM = { 
            NOTE_G_3(   3 ),     NOTE_G_2( 255 ),     NOTE_G_2( 255 ),     NOTE_G_2(  16 ), 
         NOTE_SILENT(  49 ),     NOTE_C_4(   3 ),     NOTE_C_3( 145 ),  NOTE_SILENT(  45 ), 
            NOTE_F_4(   3 ),     NOTE_F_3( 255 ),     NOTE_F_3( 255 ),     NOTE_F_3( 255 ), 
            NOTE_F_3( 255 ),     NOTE_F_3(  84 ),  NOTE_SILENT(  48 ),     NOTE_E_4(   3 ), 
            NOTE_E_3( 255 ),     NOTE_E_3(  79 ),  NOTE_SILENT(  49 ),     NOTE_C_4(   3 ), 
            NOTE_C_3( 204 ),  NOTE_SILENT(  49 ),     NOTE_A_3(   3 ),     NOTE_A_2( 206 ), 
         NOTE_SILENT(  51 ),     NOTE_D_4(  13 ),     NOTE_D_3( 192 ),  NOTE_SILENT(  49 ), 
            NOTE_G_4(   3 ),     NOTE_G_3( 255 ),     NOTE_G_3( 255 ),     NOTE_G_3( 255 ), 
            NOTE_G_3( 255 ),     NOTE_G_3( 255 ),     NOTE_G_3( 255 ),     NOTE_G_3( 255 ), 
            NOTE_G_3( 255 ),     NOTE_G_3( 255 ),     NOTE_G_3( 255 ),     NOTE_G_3( 255 ), 
            NOTE_G_3( 255 ),     NOTE_G_3( 255 ),     NOTE_G_3( 255 ),     NOTE_G_3( 255 ), 
            NOTE_G_3( 255 ),     NOTE_G_3( 105 ),  NOTE_SILENT(  48 ),    NOTE_CS_4(   3 ), 
           NOTE_CS_3( 145 ),  NOTE_SILENT(  45 ),     NOTE_F_4(   3 ),     NOTE_F_3( 141 ), 
         NOTE_SILENT(  49 ),     NOTE_G_4(   3 ),     NOTE_G_3( 255 ),     NOTE_G_3( 255 ), 
            NOTE_G_3(  16 ),  NOTE_SILENT(  49 ),     NOTE_G_4(   2 ),     NOTE_G_3( 255 ), 
            NOTE_G_3( 255 ),     NOTE_G_3(  17 ),  NOTE_SILENT(  48 ),    NOTE_CS_4(   3 ), 
           NOTE_CS_3( 141 ),  NOTE_SILENT(  49 ),     NOTE_F_4(   3 ),     NOTE_F_3( 140 ), 
         NOTE_SILENT(  50 ),     NOTE_G_4(   3 ),     NOTE_G_3( 255 ),     NOTE_G_3( 255 ), 
            NOTE_G_3(  16 ),  NOTE_SILENT(  48 ),     NOTE_G_4(   3 ),     NOTE_G_3( 255 ), 
            NOTE_G_3( 255 ),     NOTE_G_3(  21 ),  NOTE_SILENT(  45 ),    NOTE_CS_4(   2 ), 
           NOTE_CS_3( 140 ),  NOTE_SILENT(  50 ),     NOTE_F_4(   3 ),     NOTE_F_3( 141 ), 
         NOTE_SILENT(  48 ),     NOTE_G_4(   3 ),     NOTE_G_3( 255 ),     NOTE_G_3( 255 ), 
            NOTE_G_3(  21 ),  NOTE_SILENT(  44 ),     NOTE_G_4(   3 ),     NOTE_G_3( 255 ), 
            NOTE_G_3( 255 ),     NOTE_G_3(  17 ),  NOTE_SILENT(  48 ),     NOTE_G_4(   3 ), 
            NOTE_G_3( 141 ),  NOTE_SILENT(  48 ),    NOTE_CS_4(   3 ),    NOTE_CS_3( 146 ), 
  };
...
static const uint16_t Melody2[] PROGMEM = { 
            ...
            NOTE_G_6( 255 ),     NOTE_G_6( 255 ),     NOTE_G_6( 255 ),     NOTE_G_6( 255 ), 
            NOTE_G_6( 255 ),     NOTE_G_6( 255 ),     NOTE_G_6( 255 ),     NOTE_G_6( 255 ), 
            NOTE_G_6( 255 ),     NOTE_G_6(  28 ),  NOTE_SILENT( 241 ),     NOTE_G_6(  13 ), 
            NOTE_G_5( 227 ),  NOTE_SILENT(  47 ),     NOTE_G_6(   4 ),     NOTE_G_5( 237 ), 
         NOTE_SILENT(  49 ),     NOTE_G_6(   3 ),     NOTE_G_5( 141 ),  NOTE_SILENT( 146 ), 
            NOTE_G_6(   2 ),     NOTE_G_5( 237 ),  NOTE_SILENT(  48 ),     NOTE_G_6(   4 ), 
            NOTE_G_5( 141 ),  NOTE_SILENT( 241 ),     NOTE_G_6(   4 ),     NOTE_G_5( 236 ), 
         NOTE_SILENT(  49 ),     NOTE_G_6(   3 ),     NOTE_G_5( 238 ),  NOTE_SILENT(  48 ), 
            NOTE_G_6(   3 ),     NOTE_G_5( 140 ),  NOTE_SILENT( 242 ),     NOTE_G_6(   3 ), 
            NOTE_G_5( 141 ),  NOTE_SILENT(  49 ),     NOTE_G_6(   3 ),     NOTE_G_5( 141 ), 
         NOTE_SILENT(  48 ),     NOTE_G_6(   3 ),     NOTE_G_5( 141 ),  NOTE_SILENT(  50 ), 
            NOTE_G_6(  12 ),     NOTE_G_5( 227 ),  NOTE_SILENT(  49 ),     NOTE_G_6(   3 ), 
            NOTE_G_5( 236 ),  NOTE_SILENT(  49 ),     NOTE_G_6(   4 ),     NOTE_G_5( 139 ), 
         NOTE_SILENT( 146 ),     NOTE_G_6(   4 ),     NOTE_G_5( 237 ),  NOTE_SILENT(  49 ), 
            NOTE_G_6(   3 ),     NOTE_G_5( 141 ),  NOTE_SILENT( 241 ),     NOTE_G_6(  10 ), 
            NOTE_G_5( 230 ),  NOTE_SILENT(  49 ),     NOTE_G_6(   3 ),     NOTE_G_5( 237 ), 
         NOTE_SILENT(  48 ),     NOTE_G_6(   4 ),     NOTE_G_5( 140 ),  NOTE_SILENT( 242 ), 
            NOTE_G_6(   3 ),     NOTE_G_5( 141 ),  NOTE_SILENT(  49 ),     NOTE_G_6(   2 ), 
            NOTE_G_5( 141 ),  NOTE_SILENT( 242 ),     NOTE_G_6(   4 ),     NOTE_G_5( 139 ), 
         NOTE_SILENT( 241 ),     NOTE_G_7(   4 ),     NOTE_G_6(  45 ),  NOTE_SILENT(  48 ), 
           NOTE_FS_6(  47 ),  NOTE_SILENT(  49 ),     NOTE_F_7(   2 ),     NOTE_F_6(  46 ), 
         NOTE_SILENT(  48 ),     NOTE_E_7(   3 ),     NOTE_E_6(  45 ),  NOTE_SILENT(  48 ), 
           NOTE_DS_7(  15 ),    NOTE_DS_6(  32 ),  NOTE_SILENT(  50 ),     NOTE_D_6(  45 ), 
  };
static const uint16_t Melody2_Length    = sizeof( Melody2 ) / sizeof(uint16_t);

// Track 3 - This file is a MIDI version
static const uint16_t Melody3[] PROGMEM = { 
            NOTE_G_4( 255 ),     NOTE_G_4( 255 ),     NOTE_G_4(  20 ),  NOTE_SILENT(  47 ), 
            NOTE_C_5( 146 ),  NOTE_SILENT(  47 ),     NOTE_F_5( 255 ),     NOTE_F_5( 255 ), 
            NOTE_F_5( 255 ),     NOTE_F_5( 255 ),     NOTE_F_5(  89 ),  NOTE_SILENT(  46 ), 
            NOTE_E_5( 255 ),     NOTE_E_5(  84 ),  NOTE_SILENT(  47 ),     NOTE_C_5( 207 ), 
         NOTE_SILENT(  49 ),     NOTE_A_4( 209 ),  NOTE_SILENT(  37 ),     NOTE_D_5( 221 ), 
         NOTE_SILENT( 255 ),  NOTE_SILENT( 255 ),  NOTE_SILENT( 255 ),  NOTE_SILENT( 255 ), 
            NOTE_C_5( 241 ),  NOTE_SILENT(  41 ),     NOTE_C_5( 248 ),  NOTE_SILENT(  46 ), 
            NOTE_C_5( 147 ),  NOTE_SILENT( 142 ),     NOTE_C_5( 242 ),  NOTE_SILENT(  47 ), 
            NOTE_C_5( 146 ),  NOTE_SILENT( 239 ),    NOTE_CS_5( 242 ),  NOTE_SILENT(  46 ), 
           NOTE_CS_5( 243 ),  NOTE_SILENT(  46 ),    NOTE_CS_5( 146 ),  NOTE_SILENT( 143 ), 
           NOTE_CS_5( 242 ),  NOTE_SILENT(  47 ),    NOTE_CS_5( 146 ),  NOTE_SILENT( 240 ), 
           NOTE_FS_5(  14 ),    NOTE_DS_5(  35 ),  NOTE_SILENT(  46 ),     NOTE_G_5(   4 ), 
            NOTE_E_5( 143 ),  NOTE_SILENT(  46 ),     NOTE_G_5(   3 ),     NOTE_E_5( 239 ), 
         NOTE_SILENT(  48 ),     NOTE_G_5(   2 ),     NOTE_E_5( 143 ),  NOTE_SILENT( 143 ), 
            NOTE_G_5(   3 ),     NOTE_E_5( 240 ),  NOTE_SILENT(  46 ),     NOTE_E_5( 146 ), 
         NOTE_SILENT( 240 ),    NOTE_FS_5(  14 ),     NOTE_C_5(  35 ),  NOTE_SILENT(  47 ), 
            NOTE_G_5(   3 ),    NOTE_CS_5( 142 ),  NOTE_SILENT(  47 ),    NOTE_CS_5( 242 ), 
         NOTE_SILENT(  47 ),     NOTE_G_5(   3 ),    NOTE_CS_5( 142 ),  NOTE_SILENT( 144 ), 
            NOTE_G_5(   3 ),    NOTE_CS_5( 239 ),  NOTE_SILENT(  47 ),     NOTE_G_5(   3 ), 
           NOTE_CS_5( 143 ),  NOTE_SILENT( 255 ),  NOTE_SILENT( 255 ),  NOTE_SILENT(  18 ), 
            NOTE_G_5( 243 ),  NOTE_SILENT(  46 ),     NOTE_G_5( 146 ),  NOTE_SILENT( 255 ), 
         NOTE_SILENT(  80 ),     NOTE_C_5( 243 ),  NOTE_SILENT(  46 ),     NOTE_C_5( 146 ), 
         NOTE_SILENT( 239 ),     NOTE_C_5( 147 ),  NOTE_SILENT( 239 ),     NOTE_C_5( 146 ), 
         NOTE_SILENT(  47 ),     NOTE_D_5( 208 ),  NOTE_SILENT(  48 ),     NOTE_C_5( 208 ), 
         NOTE_SILENT(  49 ),     NOTE_B_4( 209 ),  NOTE_SILENT( 255 ),  NOTE_SILENT(  81 ), 
  };
