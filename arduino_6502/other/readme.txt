...
- hack 6551 UART out, replace by $F001 - output character, $F003 - 1=key pressed, $F004 - ASCII code of key pressed.
...
6.b. Source of 6502 emulator for Arduino:
=========================================
Published by miker00lz on the Arduino forum: http://forum.arduino.cc/index.php?topic=193216.0

6.c. Just to make sure
======================
...
This is the first thing I've ever done on the Arduino, and it is actually a rather ugly hack. But it's sufficient for me, this is not likely to go into mass production. Apologies for ugly code changes, and thank-you to the genius of mikeR00lz and Peter Jennings. 
