...
#include "src/NeoPixelBus/NeoPixelAnimator.h"

#define PIXEL_COUNT       64 //16  // make sure to set this to the number of pixels in your strip
#define PIXEL_PIN         14 //2  // make sure to set this to the correct pin, ignored for Esp8266
