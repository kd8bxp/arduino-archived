...
const char* ssid = "";
const char* password = "";
const char* mqtt_server = "mqtt.cheerlights.com"; //"iot.eclipse.org";

String color;
int brightness = 25; //150;
int p = 5; //p = neopixel delay

Adafruit_NeoPixel strip = Adafruit_NeoPixel(64 /*50*/, 2, NEO_RGB + NEO_KHZ800);
