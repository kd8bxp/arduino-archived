...
const unsigned char TxtDemo[] = { EFFECT_FRAME_RATE "\x06" EFFECT_SCROLL_LEFT "         LEFT SCROLL" 
                                  EFFECT_SCROLL_RIGHT "         LLORCS THGIR        "
                                  EFFECT_SCROLL_DOWN "         SCR-DOWN  " EFFECT_FRAME_RATE "\x08" 
                                  EFFECT_SCROLL_UP "         SCROL-UP   "  EFFECT_FRAME_RATE "\x08" " "
