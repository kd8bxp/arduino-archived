...
#include "src/LEDText/LEDText.h"
#include "src/LEDText/FontMatrise.h"
...
#define MATRIX_WIDTH   16 //68
#define MATRIX_HEIGHT  8 //9 //7
#define MATRIX_TYPE    HORIZONTAL_MATRIX //HORIZONTAL_ZIGZAG_MATRIX
