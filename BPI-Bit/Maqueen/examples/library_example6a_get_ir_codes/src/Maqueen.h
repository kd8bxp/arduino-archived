...
#define LED1 16 //8 //left led
#define LED2 2 //12 //right led
#define PATROLLEFT 18 //13 //left line sensor
#define PATROLRIGHT 19 //14 //right line sensor
#define CW 0x0
#define CCW 0x1
...
#define BUZZER 25 //0
#define IR 5 //16
#define BTNA 35 //5 //button A
#define BTNB 27 //11 //button B
#define TRIGGER_PIN 32 //1
#define ECHO_PIN 33 //2
