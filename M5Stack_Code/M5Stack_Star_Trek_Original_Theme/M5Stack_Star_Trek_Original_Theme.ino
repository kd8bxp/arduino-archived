...
void loop() 
{
  ...
  // 0 - Theme from "Star Trek" //sounds best with tempo 20 or 25
  // 1 - by Alexander Courage //sounds best with a tempo of 1 but still locks up for long periods of time
...
static const uint16_t Melody0[] PROGMEM = { 
           ...
           NOTE_AS_5(  89 ),  NOTE_SILENT(   2 ),    NOTE_GS_5(  11 ),  NOTE_SILENT(   2 ), 
            ...
            NOTE_F_6(  11 ),  NOTE_SILENT(   2 ),    NOTE_SILENT( 2 ),  NOTE_SILENT(   2 ), 
  };
