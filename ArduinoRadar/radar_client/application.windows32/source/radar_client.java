...
public class radar_client extends PApplet {
...
public void drawRadarLine(int angle) {
...
public void drawFoundObjects(int angle, int distance) {
...
distance = PApplet.parseInt(map(Integer.parseInt(values[1]), 1, MAX_DISTANCE, 1, radius));
} catch (Exception e) {}
}
}
...
return y;
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "--full-screen", "--bgcolor=#666666", "--stop-color=#cccccc", "radar_client" };
    if (passedArgs != null) {
