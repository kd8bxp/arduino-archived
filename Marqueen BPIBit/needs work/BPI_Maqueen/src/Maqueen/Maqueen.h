...
#define LED1 P8 //left led
#define LED2 P12 //right led
#define PATROLLEFT P13 //left line sensor
#define PATROLRIGHT P14 //right line sensor
#define CW 0x0
#define CCW 0x1
...
#define BUZZER P0
#define IR P16
#define BTNA P5 //button A
#define BTNB P11 //button B
