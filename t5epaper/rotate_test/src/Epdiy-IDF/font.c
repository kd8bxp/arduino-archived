...
void get_glyph(GFXfontDiy *font, uint32_t code_point, GFXglyphDiy **glyph)
{
...
static void IRAM_ATTR draw_char(GFXfontDiy *font, uint8_t *buffer, int *cursor_x, int cursor_y, uint16_t buf_width,
 ...
 */
static void get_char_bounds(GFXfontDiy *font, uint32_t cp, int *x, int *y, int *minx,
...
void get_text_bounds(GFXfontDiy *font, char *string, int *x, int *y, int *x1,
...
void write_mode(GFXfontDiy *font, char *string, int *cursor_x, int *cursor_y,
...
void writeln(GFXfontDiy *font, char *string, int *cursor_x, int *cursor_y,
             uint8_t *framebuffer)
{
    return write_mode(font, string, cursor_x, cursor_y, framebuffer, BLACK_ON_WHITE, NULL);
}

void write_string(GFXfontDiy *font, char *string, int *cursor_x, int *cursor_y,
                  uint8_t *framebuffer)
{
