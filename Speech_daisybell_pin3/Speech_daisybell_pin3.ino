...
//Seems to need more power than usb can handle or it didn't like my little speaker
...
void loop() {
  ...
  uint8_t *framePos = (uint8_t*) frameList;
  while(1) {
    int n;
    ...
    formantPos = (uint8_t*) formantTable + startFormant * FORMANT_SZ;
