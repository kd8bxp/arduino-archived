...
#define lPIN 6    //this is the pin the candle LEDs are connected to
...
Adafruit_NeoPixel cstrip = Adafruit_NeoPixel(numpix, lPIN, NEO_GRB + NEO_KHZ800);  //define the candle led strip
...
#define speakerPin 9 //change to match pin for speaker
...
void setAll(byte red, byte green, byte blue) {
  for(int i = 0; i < NUM_LEDS; i++ ) {
    fadeStrip.setPixelColor(i, fadeStrip.Color(red, green, blue));
  }
  fadeStrip.show();
}
