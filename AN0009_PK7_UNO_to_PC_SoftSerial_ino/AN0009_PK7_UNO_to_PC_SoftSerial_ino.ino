...
const String r_on = "RON";
const String r_off = "ROFF";
const String g_on = "GON";
const String g_off = "GOFF";
const String b_on = "BON";
const String b_off = "BOFF";
...
void loop() // run over and over
{
  ...
  if (stringComplete) {
    ...
    if(inputString == r_on) digitalWrite(red, LOW);
    if(inputString == r_off) digitalWrite(red, HIGH);
    if(inputString == g_on) digitalWrite(green, LOW);
    if(inputString == g_off) digitalWrite(green, HIGH);
    if(inputString == b_on) digitalWrite(blue, LOW);
    if(inputString == b_off) digitalWrite(blue, HIGH);
