...
#include "src/M5UnitSynth/M5UnitSynth.h"
#include "src/M5NanoC6/M5NanoC6.h"

M5UnitSynth synth;

/*
  Modified The Unit Synth library to work with the Lilygo T-OI Plus ESP32-C3
mainly changed the hard-coded &Serial2 to &Serial1 in the header file
-LeRoy Miller Mar 23, 2024

Verified that the modified library works with the M5Stack NanoC6 Apr 2, 2024
*/
...
void setup() {
    NanoC6.begin(); 
    synth.begin(&Serial1, UNIT_SYNTH_BAUD, 1, 2); //19, 18);
