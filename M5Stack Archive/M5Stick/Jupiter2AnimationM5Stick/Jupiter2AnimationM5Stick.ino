...
void draw(){
        ...
        //u8g2.drawEllipse(50+em, 35, 15, 20, U8G2_DRAW_ALL); //saucer section
           u8g2.drawCircle(70+em, 32, 2,  U8G2_DRAW_ALL);
          u8g2.drawCircle(70+em, 32, 12,  U8G2_DRAW_ALL);
          u8g2.drawCircle(70+em, 32, 25, U8G2_DRAW_ALL);
        ...
        u8g2.drawLine(50+em, 23, 50+em, 40);
        u8g2.drawLine(56+em, 25, 56+em, 37);
        u8g2.drawLine(50+em, 23, 56+em, 25 );
        u8g2.drawLine(50+em, 40, 56+em, 37 );
        u8g2.drawLine(50+em, 28, 56+em, 28);
        u8g2.drawLine(50+em, 34, 56+em, 34);
