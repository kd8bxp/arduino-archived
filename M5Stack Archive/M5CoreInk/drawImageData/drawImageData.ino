...
//Compiles with M5 Board Core 2.0.0

// This sketch works just fine on one of my CoreInk devices
// the 2nd CoreInk has issues displaying the jpgs, almost like it's 
// missing lines, but the display works for other images, and other
// text - it's very odd and very confusing to me - LeRoy Miller June 26 2025
...
display.drawJpgUrl("https://www.gutenberg.org/cache/epub/72408/pg72408.cover.medium.jpg", 0, 0);
  //display.drawJpg(jpg, ~0u, 0, 0);
  display.setTextDatum(textdatum_t::top_left);
  //display.drawString("x1.0 top_left", 0, 0);
  delay(5000);
display.drawJpgUrl("https://www.gutenberg.org/cache/epub/72539/pg72539.cover.medium.jpg", 0, 0);
