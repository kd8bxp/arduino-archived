 ...
 * v1.2 = added simple word wrap - Feb 2 2020 LeRoy Miller
...
char sz[] = "The quick brown fox jumps over the lazy dog and was surprised that he used all letters of the alphabet.";
...
void loop() {
  ...
  if (M5.BtnB.wasPressed()){
    ...
    wordWrap();
    //wordWrap("The quick brown fox jumps over the lazy dog"); // and was surprised that he used all letters of the alphabet.");
...
void wordWrap() {
  ...
  char *str;
    while ((str = strtok_r(p, " ", &p)) != NULL) { // delimiter is the space
      ...
      //landscape 25, portrait 12
       switch (screen_orientation) {
      case 1: case 3: {
       if (charCount >= 24) {  charCount = strlen(str) + 1; tb_display_print_String("\n"); Serial.println(); } 
        break;
      }
      case 2: case 4: {
        if (charCount >= 11) {  charCount = strlen(str) + 1; tb_display_print_String("\n"); Serial.println(); }
        break;
      }
      default: {
        break;
              ...
              tb_display_print_String(str, 85); tb_display_print_String(" ", 85); Serial.print(str); Serial.print(" ");
              } 
 }
