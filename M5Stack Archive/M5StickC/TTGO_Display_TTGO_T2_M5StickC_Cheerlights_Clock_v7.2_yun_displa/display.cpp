...
void display_light(void)
{
  ...
  switch(lit)
  {
    case 0: display_light0(); break;
    case 1: display_light1(); break;
    case 2: display_light2(); break;
    case 3: display_light3(); break;
    case 4: display_light4(); break; 
    default: display_light0(); break;
   }   
}
 ...
 for(j=0;j<4;j++)
  {
    for(i=0; i<7; i++)
    {
     M5.Lcd.drawLine(int(159-baseY0*sin(M_PI_2/6*i)),int(baseY0*cos(M_PI_2/6*i)),int(159-(baseY0+5)*sin(M_PI_2/6*i)), int((baseY0+5)*cos(M_PI_2/6*i)), LIGHT_COLOR);
    }
    baseY0 += 10;
  }
