...
const char* ssid     = "";
const char* password = "";
const char* mqtt_server = "mqtt.cheerlights.com"; //simplesi.cloud";
...
int geolocation(){
  ...
  lat = jsonBuffer["lat"]; lat = 39.56;
  lon = jsonBuffer["lon"]; lon = -84.30;
}
...
//some screen flashing when updating (?)
      ...
      int r = ((((rgb565Decimal >> 11) & 0x1F) * 527) + 23) >> 6;
      int g = ((((rgb565Decimal >> 5) & 0x3F) * 259) + 33) >>6;
      int b = (((rgb565Decimal & 0x1F) * 527) + 23) >> 6;
