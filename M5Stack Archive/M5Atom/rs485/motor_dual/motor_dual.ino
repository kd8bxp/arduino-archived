...
UnitRollerI2C RollerI2C2;
uint32_t p, i, d;         // Defines a variable to store the PID value
uint8_t r, g, b;
void setup()
{
    M5.begin();
    RollerI2C.begin(&Wire, 0x64, 26, 32, /*21, 22,*/ 400000); //left
     RollerI2C2.begin(&Wire, 0x65, 26, 32, /*21, 22,*/ 400000); //right
}
...
void loop()
{
    // current mode
    RollerI2C.setMode(3);
    RollerI2C2.setMode(3);
    RollerI2C.setCurrent(120000);
    RollerI2C2.setCurrent(120000);
    RollerI2C.setOutput(1);
    RollerI2C2.setOutput(1);
    ...
    RollerI2C2.setOutput(0);
    RollerI2C.setMode(2);
    RollerI2C2.setMode(2);
    RollerI2C.setPos(2000000);
    RollerI2C2.setPos(2000000);
    RollerI2C.setPosMaxCurrent(100000);
    RollerI2C2.setPosMaxCurrent(100000);
    RollerI2C.setOutput(1);
    RollerI2C2.setOutput(1);
    ...
    RollerI2C2.getPosPID(&p, &i, &d);
    printf("PosPID  P: %3.8f  I: %3.8f  D: %3.8f\n", p / 100000.0, i / 10000000.0, d / 100000.0);
    delay(100);
    printf("pos: %d\n", RollerI2C2.getPos());
    delay(100);
    printf("posMaxCurrent: %d\n", RollerI2C2.getPosMaxCurrent());
    delay(100);
    printf("actualPos: %d\n", RollerI2C2.getPosReadback());
    delay(5000);
    ...
    RollerI2C2.setOutput(0);
    RollerI2C.setMode(1);
    RollerI2C2.setMode(1);
    RollerI2C.setSpeed(240000);
    RollerI2C2.setSpeed(250000);
    RollerI2C.setSpeedMaxCurrent(100000);
    RollerI2C2.setSpeedMaxCurrent(100000);
    RollerI2C.setOutput(1);
    RollerI2C2.setOutput(1);
    ...
    RollerI2C2.getSpeedPID(&p, &i, &d);
    printf("SpeedPID  P: %3.8f  I: %3.8f  D: %3.8f\n", p / 100000.0, i / 10000000.0, d / 100000.0);
    delay(100);
    printf("speed: %d\n", RollerI2C2.getSpeed());
    delay(100);
    printf("speedMaxCurrent: %d\n", RollerI2C2.getSpeedMaxCurrent());
    delay(100);
    printf("actualSpeed: %d\n", RollerI2C2.getSpeedReadback());
    delay(5000);
