...
SH1106  display(0x3c, 5, 4); //0x3d for the Adafruit 1.3" OLED, 0x3C being the usual address of the OLED
...
void loop() 
{
  ...
  delay(10 * 1000);    //Send a request to update every 10 sec (= 10,000 ms)
}
