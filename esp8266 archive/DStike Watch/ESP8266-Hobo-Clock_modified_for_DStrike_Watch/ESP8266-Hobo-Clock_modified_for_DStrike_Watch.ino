...
/*
 * Slightly modified for use with the DStike Deauther ESP8266 Watch
 * mainly change SSD1306 OLED to SH1106 OLED, changed USE_GYRO
 * and the if USE_GYRO statements, and changed the CONTROL A, and CONTROL B
 * (Switch I thought were switches, but not sure now what they do)
 * LeRoy Miller, July 17, 2019
 * 
 * All credit should goto original programmer: tobozo
 * And the project found at:
...
// hardcoded mac case
  ...
  const char* ESPName = "HOBO-Clock-OTA";
...
int offset = -4; // timezone offset (relative to the ntp pool and geoposition)
