...
// drawLine(0, 0, 0, 130 , 3);
 //drawLine(200, 0, 40, 0, 3);
 //drawLine(50,100, 30, 0, 3);
 //SRXEHorizontalLine(0,0, 130-0+1, 3, 2); 
 //(x1 - x0 + 1)

 //writeLine(x0, y0, x1, y1, color);
 //writeLine(0, 0, 0, 100, 3);
 //writeLine(0, 100, 20, 100, 3);
 //writeLine(50, 100, 30, 0, 3);

 //drawTriangle(int16_t x0, int16_t y0, int16_t x1, int16_t y1, int16_t x2, int16_t y2, uint16_t color)

drawTriangle(100, 50, 50, 30, 30, 100, 3);
...
byte bTemp[128];
 ...
 memset(bTemp, bColorToByte[color], 3);
  ...
  if (y0 == y1) {
    SRXEVerticalLine(x0, y0, x1-x0+1, bColorToByte[color]);
  } 
  else if (x0 == x1) {
    //if (x0 > x1)
    //  _swap_int16_t(x0, x1);
    //drawFastHLine(x0, y0, x1 - x0 + 1, color);
    //SRXEHorizontalLine(x0, y0, x1 - x0 + 1, bColorToByte[color], 2);
    SRXEHorizontalLine(x0, y0, y1 - y0 + 1, bColorToByte[color], 2);
  } else {
    //startWrite();
    writeLine(x0, y0, x1, y1, color);
    //endWrite();
