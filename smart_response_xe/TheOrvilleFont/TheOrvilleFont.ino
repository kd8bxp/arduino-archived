...
void setup() {
  ...
  SRXEWriteString(0, 0,"0123456789 The Orville",FONT_LARGE, testfont, 3, 0);
  SRXEWriteString(0,30,"0123456789 The Orville",FONT_NORMAL, testfont, 3, 0);
  SRXEWriteString(0,60,"Hello World",FONT_MEDIUM, testfont, 3, 0);
  SRXEWriteString(0,96,"Hello World",FONT_SMALL, testfont, 3, 0);
