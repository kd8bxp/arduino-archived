...
void setup() {
  ...
  SRXEWriteString(0,35,"abcdefghijklmnopqrstuv",FONT_MEDIUM, acme_5_outlines, 3, 0);
  SRXEWriteString(0,50,"1234567890 !@#$%^&*()",FONT_MEDIUM, acme_5_outlines, 3, 0);
  SRXEWriteString(0,65,"-_=+{}[]'\|? / `~ \"", FONT_MEDIUM, acme_5_outlines, 3, 0);
