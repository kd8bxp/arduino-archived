...
//#include "fonts/zxpix.h" //font name: zxpix size: small/medium (readable) believe variable spaced upper and lower case

//Large/Normal Fonts
//#include "fonts/BMSPA.h" //font name: bmspa size: normal/large monospaced upper case
//#include "fonts/Commo-Monospaced.h" //font name: commoMonospaced size: normal/large monospaced, upper case bold font (IMHO does not look good)
//#include "fonts/formplex12.h" //font name: formplex12 size: normal/large monospaced upper case
//#include "fonts/HUNTER.h" //font name: hunter size: normal/large monospaced upper case bold missing some symbols
//#include "fonts/m38.h" //font name: m38 size: normal/large monospaced upper case bold
#include "fonts/Minimum+1.h" //font name: minimum1 size: normal/large monospaced upper case missing some symbols (semi readable, but not good enough)

void setup() {
  
  SRXEInit(0xe7, 0xd6, 0xa2); // Initialize the LCD
  SRXEWriteString(0, 0,"Minimum+1 Font (normal/large)",FONT_LARGE, normal, 3, 0);
 
  SRXEWriteString(0,20,"ABCDEFGHIJKLMNOPQRSTUV",FONT_NORMAL, minimum1, 3, 0);
  SRXEWriteString(0,35,"abcdefghijklmnopqrstuv",FONT_NORMAL, minimum1, 3, 0);
  SRXEWriteString(0,50,"1234567890 !@#$%^&*()",FONT_NORMAL, minimum1, 3, 0);
  SRXEWriteString(0,65,"-_=+{}[]'\|? / `~ \"", FONT_NORMAL, minimum1, 3, 0);
