...
void setup() {
  ...
  SRXEWriteString(0, 0,"Commo-Monospaced Font (normal/large)",FONT_LARGE, normal, 3, 0);
 
  SRXEWriteString(0,20,"ABCDEFGHIJKLMNOPQRSTUV",FONT_NORMAL, commoMonospaced, 3, 0);
  SRXEWriteString(0,35,"abcdefghijklmnopqrstuv",FONT_NORMAL, commoMonospaced, 3, 0);
  SRXEWriteString(0,50,"1234567890 !@#$%^&*()",FONT_NORMAL, commoMonospaced, 3, 0);
  SRXEWriteString(0,65,"-_=+{}[]'\|? / `~ \"", FONT_NORMAL, commoMonospaced, 3, 0);
