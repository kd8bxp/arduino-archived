...
void setup() {
  ...
  SRXEWriteString(0, 0,"Minimum Font (Small/Medium)",FONT_LARGE, normal, 3, 0);
 
  SRXEWriteString(0,20,"ABCDEFGHIJKLMNOPQRSTUV",FONT_MEDIUM, minimum, 3, 0);
  SRXEWriteString(0,35,"abcdefghijklmnopqrstuv",FONT_MEDIUM, minimum, 3, 0);
  SRXEWriteString(0,50,"1234567890 !@#$%^&*()",FONT_MEDIUM, minimum, 3, 0);
  SRXEWriteString(0,65,"-_=+{}[]'\|? / `~ \"", FONT_MEDIUM, minimum, 3, 0);
