...
void setup() {
  ...
  SRXESetInverse(1);
  SRXEClearScreen(); //same as SRXEFill(0);
  //SRXEWriteString(0, 0,"5x5 Font (Small/Medium)",FONT_LARGE, normal, 3, 0);
 
  SRXEWriteString(0,20,"ABCDEFGHIJKLMNOPQRSTUV",FONT_SMALL, testfont, 3, 0);
  SRXEWriteString(0,35,"abcdefghijklmnopqrstuv",FONT_SMALL, testfont, 3, 0);
  SRXEWriteString(0,50,"1234567890 !@#$%^&*()",FONT_SMALL, testfont, 3, 0);
  SRXEWriteString(0,65,"-_=+{}[]'\|? / `~ \"", FONT_SMALL, testfont, 3, 0);

delay(5000);
SRXESetInverse(0);
SRXEClearScreen();
  SRXEWriteString(0,20,"ABCDEFGHIJKLMNOPQRSTUV",FONT_MEDIUM, testfont, 3, 0);
  SRXEWriteString(0,35,"abcdefghijklmnopqrstuv",FONT_MEDIUM, testfont, 3, 0);
  SRXEWriteString(0,50,"1234567890 !@#$%^&*()",FONT_MEDIUM, testfont, 3, 0);
  SRXEWriteString(0,65,"-_=+{}[]'\|? / `~ \"", FONT_MEDIUM, testfont, 3, 0);

delay(5000);
SRXESetInverse(1);
SRXEClearScreen();
  SRXEWriteString(0,20,"ABCDEFGHIJKLMNOPQRSTUV",FONT_NORMAL, testfont, 3, 0);
  SRXEWriteString(0,35,"abcdefghijklmnopqrstuv",FONT_NORMAL, testfont, 3, 0);
  SRXEWriteString(0,50,"1234567890 !@#$%^&*()",FONT_NORMAL, testfont, 3, 0);
  SRXEWriteString(0,65,"-_=+{}[]'\|? / `~ \"", FONT_NORMAL, testfont, 3, 0);
 
delay(5000);
SRXESetInverse(0);
SRXEClearScreen();
  SRXEWriteString(0,20,"ABCDEFGHIJKLMNOPQRSTUV",FONT_LARGE, testfont, 3, 0);
  SRXEWriteString(0,35,"abcdefghijklmnopqrstuv",FONT_LARGE, testfont, 3, 0);
  SRXEWriteString(0,50,"1234567890 !@#$%^&*()",FONT_LARGE, testfont, 3, 0);
  SRXEWriteString(0,65,"-_=+{}[]'\|? / `~ \"", FONT_LARGE, testfont, 3, 0);
