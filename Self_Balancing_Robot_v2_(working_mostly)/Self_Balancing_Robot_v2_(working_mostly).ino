...
int variableDelay1;
int variableDelay2;
int neutral1 = 600;//int neutral1 = 600; //int neutral1 = 486;
int neutral2 = 470;//int neutral2 = 470; //int neutral2 = 482;
static int setpoint = 14965;
static int input = 14965;
static int lastInput = 14965;
//static int setpoint = 1450;
//static int input = 1450;
//static int lastInput = 1450;
