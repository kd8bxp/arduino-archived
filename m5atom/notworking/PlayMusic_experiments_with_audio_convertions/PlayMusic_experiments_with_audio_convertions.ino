...
/*
 * Convert MP3 to wav with sample rate of 88200, 16bit PCM - seems like it plays too fast
 * these tools  found so far that will convert wav to a c++ array
 * https://bitluni.net/wp-content/uploads/2016/12/bin2h8bit.html
 * http://tomeko.net/online_tools/file_to_hex.php?lang=en
 * both seem to play the file way too fast
 * 
 */
...
extern const unsigned char audio_chocobo[];
long arraySize = 164000; //guess at the size of the array (?)  
...
void loop()
{
    ...
    if( Spakeflag )
    {
        i2s_write(SPEAK_I2S_NUMBER, audio_chocobo, arraySize, &bytes_written, 1000); //portMAX_DELAY);
    }
