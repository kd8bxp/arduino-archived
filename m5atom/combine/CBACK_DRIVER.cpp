...
void CBACK_DRIVER::Write2Byte(uint8_t address, uint8_t Register_address,
                              uint16_t data) {
    Wire1.beginTransmission(address);
    Wire1.write(Register_address);
...
uint8_t CBACK_DRIVER::ReadBytes(uint8_t address, uint8_t subAddress,
...
uint8_t CBACK_DRIVER::SetServoPulse(uint8_t Servo_CH,
