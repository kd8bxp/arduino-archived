...
if (digitalRead(UP) == 0) {microbit.print("UP");}
if (digitalRead(DOWN) == 0) {microbit.print("DOWN");}
if (digitalRead(LEFT) == 0) {microbit.print("LEFT");}
if (digitalRead(RIGHT) == 0) {microbit.print("RIGHT");}
