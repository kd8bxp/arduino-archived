 ...
 * 
 * Aug 1, 2017 added I2C LCD - LeRoy Miller 2017
 * corrected Ultrasonic reading
 ******************************************/
...
/*-----( Define constants )-----*/
int driveSpeed = 100; //motor speed for the robot;
...
void loop(){ /*----( LOOP: RUNS CONSTANTLY )----*/
  ...
  if(echoDuration > DURATION_PER_INCH){ //If the object is over an inch away:
    ...
    digitalWrite(R_FORWARDS_PIN, HIGH); //Set the right motor go forward
    digitalWrite(R_REVERSE_PIN, LOW);
