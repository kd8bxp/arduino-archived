...
Works but needs inprovement. - LeRoy Miller, 2017
 ******************************************/
...
const int L_LINE_PIN = 35;
const int C_LINE_PIN = 37;
const int R_LINE_PIN = 39;

const int FAR_R_LINE_PIN = 41; //If your robot only has three IR line sensors, comment these two lines out an un-comment the two lines below:
const int FAR_L_LINE_PIN = 33;
