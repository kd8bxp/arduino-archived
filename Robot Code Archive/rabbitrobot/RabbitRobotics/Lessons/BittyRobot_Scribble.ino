...
const int SERVO_PIN = 8; //The digital pin the data line of the servo is attatched to on the MEGA
...
analogWrite(L_ENABLE_PIN, 255); //Make the left motor run at full speed and the right motor run at 23% speed
digitalWrite(R_ENABLE_PIN, 60); // This should make the robot turn in a circle clockwise
