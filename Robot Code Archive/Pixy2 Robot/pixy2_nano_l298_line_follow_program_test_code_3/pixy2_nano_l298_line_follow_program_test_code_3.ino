...
#define ZUMO_FAST       100 //200
#define ZUMO_SLOW       75 //150
#define X_CENTER         (pixy.frameWidth/2)

#define leftOffset 0
#define rightOffset 25

Pixy2 pixy;
PIDLoop headingLoop(550, 0, 0, false); //1000 works lets see what happens with smaller #
...
void loop(){ 
 int8_t res;
  ...
  if (res&LINE_VECTOR)
  {
    ...
    left = headingLoop.m_command - leftOffset;
    right = -headingLoop.m_command - rightOffset;
  ...
  if (res&LINE_BARCODE)
  {
    ...
    //because my robot seems to be opposite that of the Pololu Zumo robot
