...
double kp = 3.4; //1.68; //4.9//0.9; //1.4 //3.3; //2.26;
//double kp = 1.92;
//double ki = 0.27;
double ki = .001; //0.001;
//double kd = 2.6;
double kd = 1.5; //0.6; //3.4 //3.5;
double error;
double dErr;
double accelTotal;
int16_t ax, ay, az;
...
int variableDelay1;
int variableDelay2;
int neutral1 = 599; //599; //604; //604;//int neutral1 = 600; //int neutral1 = 486;
int neutral2 = 402; //410;//int neutral2 = 470; //int neutral2 = 482;
