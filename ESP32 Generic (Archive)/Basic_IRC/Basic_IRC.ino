...
#define IRC_NICKNAME "MCUIRCClient122"
#define IRC_USER     "MCUIRCClient122"
...
void loop() {
  if (!client.connected()) {
    ...
    if (client.connect(IRC_NICKNAME, IRC_USER)) {
      ...
      client.sendRaw("/JOIN #Automation_Technology");
      client.sendMessage("Automation_Technology", "Hello World");
    } else {
