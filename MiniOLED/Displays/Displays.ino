...
#include "src/M5GFX/M5UnitMiniOLED.h"
...
void setup(void)
{
  ...
  cfg.external_display.module_display = false; //true;  // default=true. use ModuleDisplay
  cfg.external_display.atom_display   = false; //true;  // default=true. use AtomDisplay
  ...
  cfg.external_display.unit_mini_oled = true; //false; // default=true. use UnitMiniOLED
...
// cfg.unit_oled.i2c_port = I2C_NUM_0;
 ...
 cfg.unit_mini_oled.pin_sda  = GPIO_NUM_25;
 cfg.unit_mini_oled.pin_scl  = GPIO_NUM_21;
