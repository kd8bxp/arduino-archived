...
#include "src/LEDText/LEDMatrix.h"
...
#define MATRIX_WIDTH   16 //80  // Set this negative if physical led 0 is opposite to where you want logical 0
#define MATRIX_HEIGHT  9 //10  // Set this negative if physical led 0 is opposite to where you want logical 0
