...
display.setFont(ArialMT_Plain_10);
 display.drawString(14, 0, "Tandy SD Card Drive");
display.drawString(22,9,"ported to ESP32");
display.drawString(13,19,"by LeRoy Miller, 2018");
display.drawString(0,29,"Code based on: ");
display.drawString(12,39,"MyTeSed By David");
display.drawString(13,49,"Stephenson, 2017");
display.display();
delay(5000);
display.clear();
	if(!SD.begin(5)){
