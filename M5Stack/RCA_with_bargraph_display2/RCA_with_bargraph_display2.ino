...
for (int i=25; i>0; i-- ) {
  gfx_rca.fillRect(95, 50 + i, 5, 5, TFT_WHITE);
  gfx_rca.fillRect(101, 55+ i, 5, 5, TFT_WHITE);
  gfx_rca.fillRect(89, 55+ i, 5, 5, TFT_WHITE);
  gfx_rca.fillRect(95, 50+25-i, 5, 5, TFT_WHITE);
  gfx_rca.fillRect(101, 45+20 - i, 5, 5, TFT_WHITE);
  gfx_rca.fillRect(89, 45+20 - i, 5, 5, TFT_WHITE);
  delay(20);
  
}

for (int i=25; i>0; i-- ) {
  gfx_rca.fillRect(95, 50 +i, 5, 5, TFT_BLACK);
  gfx_rca.fillRect(101, 55+ i, 5, 5, TFT_BLACK);
  gfx_rca.fillRect(89, 55+ i, 5, 5, TFT_BLACK);
  gfx_rca.fillRect(95, 50+25-i, 5, 5, TFT_BLACK);
  gfx_rca.fillRect(101, 45+20 - i, 5, 5, TFT_BLACK);
  gfx_rca.fillRect(89, 45 +20- i, 5, 5, TFT_BLACK);
  delay(20);
}
