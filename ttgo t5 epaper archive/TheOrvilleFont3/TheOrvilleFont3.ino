...
void rotated() {
  epd_poweron();
   int cursor_x = 0;
    int cursor_y = 540;
    writeln((GFXfont *)&spaceagerotate16, "T", &cursor_x, &cursor_y, framebuffer);
    //delay(500);
     cursor_x = 0;
     cursor_y -= 30;
    writeln((GFXfont *)&spaceagerotate16, "h", &cursor_x, &cursor_y, framebuffer);
    //delay(500);
     cursor_x = 0;
     cursor_y -= 30;
    writeln((GFXfont *)&spaceagerotate16, "e", &cursor_x, &cursor_y, framebuffer);
    // delay(500);
     cursor_x = 0;
     cursor_y -= 30;
    writeln((GFXfont *)&spaceagerotate16, " ", &cursor_x, &cursor_y, framebuffer);
    // delay(500);
     cursor_x = 0;
     cursor_y -= 30;
    writeln((GFXfont *)&spaceagerotate16, "O", &cursor_x, &cursor_y, framebuffer);
   //  delay(500);
     cursor_x = 0;
     cursor_y -= 30;
    writeln((GFXfont *)&spaceagerotate16, "r", &cursor_x, &cursor_y, framebuffer);
   //  delay(500);
     cursor_x = 0;
     cursor_y -= 30;
    writeln((GFXfont *)&spaceagerotate16, "v", &cursor_x, &cursor_y, framebuffer);
   //  delay(500);
     cursor_x = 0;
     cursor_y -= 30;
    writeln((GFXfont *)&spaceagerotate16, "i", &cursor_x, &cursor_y, framebuffer);
   //  delay(500);
     cursor_x = 0;
     cursor_y -= 30;
    writeln((GFXfont *)&spaceagerotate16, "l", &cursor_x, &cursor_y, framebuffer);
   //  delay(500);
     cursor_x = 0;
     cursor_y -= 30;
    writeln((GFXfont *)&spaceagerotate16, "l", &cursor_x, &cursor_y, framebuffer);
