...
//	display.display();
if (botarray[steps] == 2) {bot.forward(100,leftspeed,rightspeed);} //2 is forward
if (botarray[steps] == 5) {bot.stop();}						   //5 is Stop
if (botarray[steps] == 8) {bot.back(100, leftspeed, rightspeed);}  //8 is resverse
if (botarray[steps] == 4) {bot.left(100, leftspeed, rightspeed+20);} //4 turn left
if (botarray[steps] == 6) {bot.right(100, leftspeed+20, rightspeed);} //6 turn right
